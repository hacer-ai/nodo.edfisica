...
st.set_page_config(
    page_title="Nodo + Educacion Física",
    page_icon="🧠",
...
st.sidebar.title("Nodo + Educacion Física")
st.sidebar.divider()
st.sidebar.markdown("Mentor De Educacion Física", unsafe_allow_html=True)
st.sidebar.markdown("hacer Agent Toolkit 1.0")
st.sidebar.divider()

st.write("""<img height="120" src="https://es.nodoeafit.com/wp-content/uploads/2024/11/EDUCACION-FISICA.png"/>""", unsafe_allow_html=True)
